...
typedef void(*sc_node_colide_cb_t)(struct ngine_sc_node* _sc_node);

def_struct_mod(ngine_sc_node, phys);

struct ngine_sc_node_mod_phys {
  struct rbRigidBody* 	rigid_body;
  float 		mass;
  char 			dynamic;
  sc_node_colide_cb_t 	colide_cb;
