...
typedef int(*event_handler_t)(struct ngine_socket* _sock, void* _args);
...
void 			ngine_server_add_handler(struct ngine_server* _self, uint32_t _id, event_handler_t _accept_handler, void* _args);
