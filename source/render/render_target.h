...
inline void 			ngine_render_target_size(struct ngine_render_target* _self, uint32_t _w, uint32_t _h);
inline void 			ngine_render_target_get_attached_cam(struct ngine_render_target* _self);
