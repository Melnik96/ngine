...
void main() {
	...
	gl_TexCoord[1].xy = direction.xy * length / 32.0f;
}
...
VERTEX_OUT main(VERTEX_IN IN) {
	...
	OUT.texcoord_1.x = direction.x * length / 32.0f;
	OUT.texcoord_1.y = -direction.y * length / 32.0f;
