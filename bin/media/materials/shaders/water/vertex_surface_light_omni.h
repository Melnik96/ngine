 ...
 *
 * File:    vertex_surface_light_omni.h
...
\******************************************************************************/
	...
	#ifndef VERTEX_SURFACE_LIGHT_OMNI
		#define VERTEX_SURFACE_LIGHT_OMNI
		...
		gl_TexCoord[5] = float4(vertex.xyz - s_light_position,0.0f) * s_light_transform;
		
		#ifdef SHADOW
			gl_TexCoord[6].xyz = (vertex.xyz - s_light_shadow_offset) * s_light_shadow_depth_range.x;
			gl_TexCoord[6].w = s_light_shadow_depth_range.y;
		#endif
...
\******************************************************************************/
		...
		OUT.texcoord_5 = mul(vertex.xyz - s_light_position,(float3x3)s_light_transform);
		
		#ifdef SHADOW
			OUT.texcoord_6.xyz = (vertex.xyz - s_light_shadow_offset) * s_light_shadow_depth_range.x;
			OUT.texcoord_6.w = s_light_shadow_depth_range.y;
		#endif
