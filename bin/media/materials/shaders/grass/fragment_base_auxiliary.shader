...
void main() {
	...
	texture2DAlphaDiscard(s_texture_0,gl_TexCoord[0].xy,gl_TexCoord[0].z);
...
half4 main(FRAGMENT_IN IN) : COLOR {
	...
	tex2DAlphaDiscard(s_texture_0,IN.texcoord_0.xy,IN.texcoord_0.z);
...
FRAGMENT_ALPHA_OUT main(FRAGMENT_IN IN) {
	...
	OUT = texture2DAlphaDiscard(s_texture_0,s_sampler_0,IN.texcoord_0.xy,IN.texcoord_0.z);
