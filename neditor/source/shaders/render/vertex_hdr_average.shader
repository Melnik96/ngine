 ...
 *
 * File:    vertex_hdr_average.shader
...
void main() {
	...
	gl_TexCoord[0] = texcoord + offset * float4(1.0f, 1.0f,-1.0f,-1.0f);
	gl_TexCoord[1] = texcoord + offset * float4(1.0f,-1.0f,-1.0f, 1.0f);
}
...
VERTEX_OUT main(VERTEX_IN IN) {
	...
	OUT.texcoord_0 = texcoord + offset * float4(1.0f, 1.0f,-1.0f,-1.0f);
	OUT.texcoord_1 = texcoord + offset * float4(1.0f,-1.0f,-1.0f, 1.0f);
