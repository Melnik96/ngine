...
void neditor_default_scene_create() {
  ...
  ngine_camera_persp(node_cam->attached_obj, 45.f);
  ...
  struct ngine_render_target* rt = ngine_render_target_create(node_cam, 1024, 600);
  rt->fbuf = ngine_intense()->windows->fbuf;
