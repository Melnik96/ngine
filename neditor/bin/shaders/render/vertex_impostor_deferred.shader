 ...
 *
 * File:    vertex_impostor_deferred.shader
...
attribute float2 s_attribute_1;
...
void main() {
	...
	gl_TexCoord[0].xy = s_attribute_1;
	
	gl_TexCoord[1].xyz = (s_attribute_0.xyz - s_camera_position) / s_depth_range.y;
}
...
VERTEX_OUT main(VERTEX_IN IN) {
	...
	OUT.texcoord_1 = (IN.position.xyz - s_camera_position) / s_depth_range.y;
